            ...
            <div class="content">
                ...
                <div class="panel panel-default">
                        <div class="panel-heading" id="tipoagenda">
                            <div class="row">
                            <div class="col-xs-6">ESPECIALIDADES</div>
                            <div class="col-xs-6 text-right"><button type="button" class="btn btn_edit" id="btn_add" data-toggle="modal" data-target="#modalEspecialidades"><span class="fa fa-new pull-right"></span>Agregar</button></div>
                            </div>
                        </div>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <tbody>
                                                <?php foreach($especialidades AS $key=>$fila):?>    
                                                    ...
                                                    <td><button type="button" id="btn_edit" alt="Editar" title="Editar" class="btn btn_edit" data-toggle="modal" data-id="<?php print $key;?>" data-target="#modalEspecialidades"><span class="fa fa-edit pull-right"></span></button></td>
                                                    </tr>        
                                                <?php endforeach;?>
                                            </tbody>
                                            </table>
